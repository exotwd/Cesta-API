(() => {
  ...
  const ROUTING_FIELDS = [
    ...
    { group: "Candidate generation", key: "range_search_window_seconds", label: "Range search window", type: "number", min: 0, max: 21600, step: 300, unit: "seconds", detail: "Additional departure window searched with bounded rRAPTOR-style probes. Set 0 to keep a single departure probe." },
    { group: "Candidate generation", key: "max_range_departures", label: "Range departure limit", type: "number", min: 1, max: 96, step: 1, unit: "departures", detail: "Maximum distinct origin departure times sampled inside the range search window." },
